...
async def send_weekly_reminder():
    ...
    await channel.send("@everyone 24 hours until the next meeting! \n P.S: Play Hollow Knight")
...
async def weekly_reminder_calculate():
    ...
    next_weekday = get_next_weekday(today_weekday,2) #0 = Monday, 3:30am next day, Thursday is 9:30pm here Wednesday
